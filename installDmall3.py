...
def getDownloadURL(rootURL, version, env="-dmtest"):
    ...
    downloadPath = rootURL + latestBuildID + "/artifact/Dmall2/build/bakApk/"
    ...
    for i in range(len(allNames)):
        if env in allNames[i]:
            ...
            return (latestBuildID, downloadURL)
...
if __name__ == "__main__":
    ...
    if flag:
        ...
        # 预发环境：-pre 
        # 正式环境：-release 
        downloadURL = getDownloadURL(rootURL, "4.0.0", "-release")
        if downloadURL:
